...
│                   集群规模演进路径                          │
│                                                             │
│  3-50 节点          50-100 节点         100-1000 节点        │
│     ↓                   ↓                    ↓              │
│  扁平架构           扁平架构            树形分组架构         │
│  Gossip+Quorum    Gossip+Quorum      分组+智能路由        │
│  无分组            无分组            组内2PC+组间Gossip   │
│                                                             │
└─────────────────────────────────────────────────────────────┘
```
...
└─────────────────┴─────────────────┘
    ↓                  ↓
决策 commit    决策 rollback
    ↓                  ↓
广播决策        广播决策
    ↓                  ↓
Gossip 同步状态  Gossip 同步状态
    ↓                  ↓
返回客户端成功   返回客户端失败
```
