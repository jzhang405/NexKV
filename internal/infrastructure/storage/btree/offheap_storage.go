...
return nil, errpkg.Wrapf(errpkg.ErrBTreeInvalidPage, "page %d is not a leaf page", pageID)
}
...
if s.pa.IsLeaf(rawID) {
return nil, errpkg.Wrapf(errpkg.ErrBTreeInvalidPage, "page %d is not a node page", pageID)
}
